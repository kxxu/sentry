...
(
    ...
    `CREATE_TIME` BIGINT NOT NULL,
    `WITH_GRANT_OPTION` CHAR(1) NOT NULL,
    `RESOURCE_NAME_0` VARCHAR(64) DEFAULT '__NULL__',
    `RESOURCE_NAME_1` VARCHAR(64) DEFAULT '__NULL__',
    `RESOURCE_NAME_2` VARCHAR(64)  DEFAULT '__NULL__',
    `RESOURCE_NAME_3` VARCHAR(64)  DEFAULT '__NULL__',
    `RESOURCE_TYPE_0` VARCHAR(64)  DEFAULT '__NULL__',
    `RESOURCE_TYPE_1` VARCHAR(64)  DEFAULT '__NULL__',
    `RESOURCE_TYPE_2` VARCHAR(64)  DEFAULT '__NULL__',
    `RESOURCE_TYPE_3` VARCHAR(64)  DEFAULT '__NULL__',
